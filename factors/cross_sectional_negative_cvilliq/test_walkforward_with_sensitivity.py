"""
Cross-Sectional CVILLIQ Factor - Walk-Forward Optimization with Sensitivity Analysis
...
if __name__ == "__main__":
    ...
    PARAM_GRID = {
        "window": range(2, 450, 1), # CVILLIQ window: 10-60 days, step 5
