"""
Donchian Strategy - Parameter Optimization
Donchian策略 - 參數優化測試
...
def run_optimization(
    ...
    # 步驟2: 設置參數網格
    param_grid = {
        'lookback': list(range(lookback_range[0], lookback_range[1], lookback_range[2]))
    }
    ...
    data_source = f"Optimization_Donchian_{data_config}_{objective}_{date_str}"
    ...
    if verbose:
        ...
        print(f"Best Parameters: lookback={best_params['lookback']}, {objective}={optimizer.best_score:.3f}")
...
if __name__ == "__main__":
    ...
    # ========== 優化參數 ==========
    LOOKBACK_RANGE = (1400, 1584, 1)       # lookback從2到90，步長1
    ...
    # 執行優化 (Medium 風格簡潔輸出)
    print(f"Parameter Optimization - Donchian Strategy")
