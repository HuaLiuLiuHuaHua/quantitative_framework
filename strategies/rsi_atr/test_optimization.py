"""
RSI-ATR Strategy - Parameter Optimization
RSI-ATR策略 - 參數優化測試
...
- rsi_long_threshold: 55 到 70，步長5
- rsi_short_threshold: 30 到 45，步長5
...
def run_optimization(
    ...
    # 步驟2: 設置參數網格
    param_grid = {
        'rsi_window': list(range(rsi_window_range[0], rsi_window_range[1], rsi_window_range[2])),
        'rsi_long_threshold': list(range(rsi_long_threshold_range[0], rsi_long_threshold_range[1], rsi_long_threshold_range[2])),
        'rsi_short_threshold': list(range(rsi_short_threshold_range[0], rsi_short_threshold_range[1], rsi_short_threshold_range[2])),
    ...
    data_source = f"Optimization_RSI_ATR_{data_config}_{objective}_{date_str}"
    ...
    plot_optimization_results_medium_style(
        ...
        param_names=['rsi_window', 'rsi_long_threshold', 'rsi_short_threshold', 'atr_window', 'atr_multiplier'],
    ...
    if verbose:
        ...
        print(f"Best Parameters: rsi_window={best_params['rsi_window']}, rsi_long_threshold={best_params['rsi_long_threshold']}, rsi_short_threshold={best_params['rsi_short_threshold']}, atr_window={best_params['atr_window']}, atr_multiplier={best_params['atr_multiplier']:.2f}, {objective}={optimizer.best_score:.3f}")
...
if __name__ == "__main__":
    ...
    # ========== 優化參數 ==========
    RSI_WINDOW_RANGE = (1, 25, 1)           # rsi_window從10到20，步長2
    RSI_LONG_THRESHOLD_RANGE = (50, 95, 5)   # rsi_long_threshold從55到70，步長5
    RSI_SHORT_THRESHOLD_RANGE = (5, 51, 5)  # rsi_short_threshold從30到45，步長5
    ATR_WINDOW_RANGE = (1, 5, 1)           # atr_window從10到20，步長2
    ...
    # 執行優化 (Medium 風格簡潔輸出)
    print(f"Parameter Optimization - RSI-ATR Strategy")
