"""
SMA-ATR Strategy - Basic Backtest
SMA-ATR策略 - 基礎回測測試
...
def run_backtest(
    ...
    # 根據數據配置設定年化參數
    periods_per_year = 365 if "_1d" in data_config else 365 * 24  # 日線365天，小時線365*24小時
    ...
    data_source = f"Backtest_SMA_ATR_{data_config}_sma{sma_period}_atr{atr_window}_{date_str}"

    # 保存到strategies/sma_atr/results/
    ...
    plot_backtest_results(
        ...
        data=df,
        signals=signals,
        title=f"SMA-ATR策略回測 (sma={sma_period}, atr={atr_window})",
