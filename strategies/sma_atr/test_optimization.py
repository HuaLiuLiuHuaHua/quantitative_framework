"""
SMA-ATR Strategy - Parameter Optimization
SMA-ATR策略 - 參數優化測試
...
def run_optimization(
    ...
    sma_period_range: tuple = (10, 50, 5),
    ...
    Args:
        ...
        sma_period_range: sma_period參數範圍 (start, end, step)
    ...
    # 步驟2: 設置參數網格
    param_grid = {
        'sma_period': list(range(sma_period_range[0], sma_period_range[1], sma_period_range[2])),
    ...
    data_source = f"Optimization_SMA_ATR_{data_config}_{objective}_{date_str}"
    ...
    plot_optimization_results_medium_style(
        ...
        param_names=['sma_period', 'atr_window', 'atr_multiplier'],
    ...
    if verbose:
        ...
        print(f"Best Parameters: sma_period={best_params['sma_period']}, atr_window={best_params['atr_window']}, atr_multiplier={best_params['atr_multiplier']:.2f}, {objective}={optimizer.best_score:.3f}")
...
if __name__ == "__main__":
    ...
    # 執行優化 (Medium 風格簡潔輸出)
    print(f"Parameter Optimization - SMA-ATR Strategy")
