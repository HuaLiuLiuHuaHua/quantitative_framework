...
def run_walkforward(
    ...
    data_source = f"WalkForward_SMAATR_{data_config}_{date_str}"
...
if __name__ == "__main__":
    ...
    SMA_PERIOD_RANGE = (20, 100, 10)
    ATR_WINDOW_RANGE = (10, 30, 5)
    ATR_MULTIPLIER_RANGE = (1.0, 3.0, 0.5)
