...
def fetch_bybit_tia_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的TIA日K數據
        >>> df = fetch_bybit_tia_1d_data(
    ...
    if save:
        ...
        filename = f"TIAUSDT_1d_{start_str}_{end_str}.csv"
