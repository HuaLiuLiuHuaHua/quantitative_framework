...
def fetch_bybit_pepe_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的PEPE日K數據
        >>> df = fetch_bybit_pepe_1d_data(
    ...
    if save:
        ...
        filename = f"1000PEPEUSDT_1d_{start_str}_{end_str}.csv"
