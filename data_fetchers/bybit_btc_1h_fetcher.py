"""
Bybit BTC 1H Data Fetcher
Bybit BTC 1小時K線數據抓取器
...
def fetch_bybit_btc_1h_data(
    ...
    if save:
        ...
        filename = f"BTCUSDT_1h_{start_str}_{end_str}.csv"
