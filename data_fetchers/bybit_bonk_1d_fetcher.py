...
def fetch_bybit_bonk_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的BONK日K數據
        >>> df = fetch_bybit_bonk_1d_data(
    ...
    if save:
        ...
        filename = f"1000BONKUSDT_1d_{start_str}_{end_str}.csv"
