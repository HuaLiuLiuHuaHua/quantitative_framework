"""
Bybit TRUMP 1D Data Fetcher
Bybit TRUMP 日K線數據抓取器
...
def fetch_bybit_trump_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的TRUMP日K數據
        >>> df = fetch_bybit_trump_1d_data(
    ...
    if save:
        ...
        filename = f"TRUMPUSDT_1d_{start_str}_{end_str}.csv"
