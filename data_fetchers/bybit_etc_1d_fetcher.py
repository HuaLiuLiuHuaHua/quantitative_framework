...
def fetch_bybit_etc_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的ETC日K數據
        >>> df = fetch_bybit_etc_1d_data(
    ...
    if save:
        ...
        filename = f"ETCUSDT_1d_{start_str}_{end_str}.csv"
