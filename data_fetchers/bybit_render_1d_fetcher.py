"""
Bybit RENDER 1D Data Fetcher
Bybit RENDER 日K線數據抓取器
...
def fetch_bybit_render_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的RENDER日K數據
        >>> df = fetch_bybit_render_1d_data(
    ...
    if save:
        ...
        filename = f"RENDERUSDT_1d_{start_str}_{end_str}.csv"
