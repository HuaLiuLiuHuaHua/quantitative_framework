"""
Bybit MATIC 1D Data Fetcher
Bybit MATIC 日K線數據抓取器
...
def fetch_bybit_matic_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的MATIC日K數據
        >>> df = fetch_bybit_matic_1d_data(
    ...
    if save:
        ...
        filename = f"MATICUSDT_1d_{start_str}_{end_str}.csv"
