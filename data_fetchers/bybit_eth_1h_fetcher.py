"""
Bybit ETH 1H Data Fetcher
Bybit ETH 1小時K線數據抓取器
...
def fetch_bybit_eth_1h_data(
    start_date: Optional[Union[str, datetime]] = None,
    end_date: Optional[Union[str, datetime]] = None,
    days: int = 365,
    limit: int = 1000,
    sleep_per_request: float = 0.15,
    chunk_days: int = 30,  # 1H使用30天分塊：每塊最多1000條小時K線數據（30*24=720）
    save: bool = True,
    verbose: bool = False,
) -> pd.DataFrame:
    """
    抓取Bybit ETH/USDT 1小時K線數據
    ...
    Example:
        >>> # 抓取2020-2024年的ETH1小時K數據
        >>> df = fetch_bybit_eth_1h_data(
    ...
    if save:
        ...
        filename = f"ETHUSDT_1h_{start_str}_{end_str}.csv"
