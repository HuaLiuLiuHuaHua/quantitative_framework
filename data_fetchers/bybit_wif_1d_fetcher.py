...
def fetch_bybit_wif_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的WIF日K數據
        >>> df = fetch_bybit_wif_1d_data(
    ...
    if save:
        ...
        filename = f"WIFUSDT_1d_{start_str}_{end_str}.csv"
