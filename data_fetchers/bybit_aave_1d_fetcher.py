...
def fetch_bybit_aave_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的AAVE日K數據
        >>> df = fetch_bybit_aave_1d_data(
    ...
    if save:
        ...
        filename = f"AAVEUSDT_1d_{start_str}_{end_str}.csv"
