...
def fetch_bybit_near_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的NEAR日K數據
        >>> df = fetch_bybit_near_1d_data(
    ...
    if save:
        ...
        filename = f"NEARUSDT_1d_{start_str}_{end_str}.csv"
