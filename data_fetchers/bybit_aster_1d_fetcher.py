"""
Bybit ASTER 1D Data Fetcher
Bybit ASTER 日K線數據抓取器
...
def fetch_bybit_aster_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的ASTER日K數據
        >>> df = fetch_bybit_aster_1d_data(
    ...
    if save:
        ...
        filename = f"ASTERUSDT_1d_{start_str}_{end_str}.csv"
