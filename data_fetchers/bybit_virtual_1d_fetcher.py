"""
Bybit VIRTUAL 1D Data Fetcher
Bybit VIRTUAL 日K線數據抓取器
...
def fetch_bybit_virtual_1d_data(
    ...
    Example:
        >>> # 抓取2020-2024年的VIRTUAL日K數據
        >>> df = fetch_bybit_virtual_1d_data(
    ...
    if save:
        ...
        filename = f"VIRTUALUSDT_1d_{start_str}_{end_str}.csv"
